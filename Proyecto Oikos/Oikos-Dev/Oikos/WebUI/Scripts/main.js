...
(function($) {
    ...
    /* Current Currency */
    $('.select-currency-current').on('click',
        function() {
    ...
    /* Current Language */
    $('.select-language-current').on('click',
        function() {
    ...
    function categoryMenu() {
        ...
        // Category Menu More
        $('.catmenu-moretrigger a').on('click',
            function(e) {
                e.preventDefault();
...
//                var oldValue = 1;
                var newVal;
                if ($button.text() == "+") {
                    if (oldValue < productStockQuantity) {
                        newVal = parseFloat(oldValue) + 1;
                    } else {
                        newVal = productStockQuantity;
                    }
                }  else {
                    if (oldValue > 1) {
                        newVal = parseFloat(oldValue) - 1;
    ...
    $('.pdetails-color ul li, .pdetails-size ul li').on('click',
        function() {
            $(this).addClass('checked').siblings().removeClass('checked');
        });

    /* Rating Hover Action */
    $('.rattingbox.hover-action span').on('mouseenter',
        function() {
    ...
    /* Quickview Modal */
    $('.quickview-trigger').on('click',
        function(e) {
            e.preventDefault();
            $('.quickmodal').toggleClass('is-visible');
        });
    $('.quickmodal').find('.body-overlay').on('click',
        function() {
            $(this).parents('.quickmodal').removeClass('is-visible');
        });
    $('.quickmodal-close').on('click',
        function() {
    ...
    /* Product Viewmode */
    $('.shop-filters-viewmode').on('click',
        'button',
        function() {
    ...
    $('.checkout-info-login-trigger, .checkout-info-coupon-trigger').on('click',
        function(e) {
            e.preventDefault();
    ...
    $('.different-address-form-trigger .ho-checkbox').on('change',
        function() {
            if ($(this).is(':checked')) {
