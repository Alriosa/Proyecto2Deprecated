...
function validateIfNoProductsWithActiveSession() {
    try {
        getActiveUserId();
    } catch (e) {
        var alert =
...
function activateLogIn() {
    if (localStorage.getItem("Credentials") === null) {
        sessionStorage.setItem("previousHref", window.location.href);
        $("#btnAddToCart").addClass("d-none");
        $("#btnGoToLogIn").removeClass("d-none");
    } else {
        sessionStorage.removeItem("previousHref");
    }
}
