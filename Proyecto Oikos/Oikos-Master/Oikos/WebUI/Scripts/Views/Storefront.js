...
function Storefront() {
    ...
    this.RetrieveByCategoryId = function () {
        productLstDb = this.ctrlActions.GetToAPIAsync('Product/RetrieveAllByCategory?catId=' + cId);
        productLst = productLstDb.Data;
